...
public class Rsa_java {
    ...
    static long e = 5;//27; // 1 < e < z, e teilerfremd zu z    AKA d
...
//        for(int i = 0; i < encryptedStr.length()-2; i++) {
    ...
    public static void main(String[] args) {
        ...
        String sPlainIn = "hat der alte, hexenmeister, sich doch einmal wegbegeben.\nund nun sollen seine geister\nauch nach meinem willen leben.";
        ...
        // . -> |  ,-> }
        String sCrypted     = new String( encrypt( sPlainIn.replace(' ', '{').replace('.', '|').replace(',', '}') ) );
        ...
        String sPlainOut    = sTemp.replace('{', ' ').replace('|', '.').replace('}', ',');
